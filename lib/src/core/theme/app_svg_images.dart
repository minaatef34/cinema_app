class AppSvgImages {
  ...
  static String searchIcon = "assets/svg/search_light.svg";
  static String userIcon = "assets/svg/user_light.svg";
  static String playIcon = "assets/svg/play_light.svg";
  static String filterIcon = "assets/svg/filter_icon.svg";
  static String navBottomIcon1 = "assets/svg/nav_bottom_icon1.svg";
